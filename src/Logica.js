class Logica {
    ...
    preload() {
        ...
        this.mymusica = this.app.loadSound("/imagenes/musica.mp3");
        ///////// TIPOGRAFIA /////////
    ...
    click() {
        ...
        for (let i = 0; i < this.enemigo.length; i++) {
            ...
            //console.log(meMataron);

            if (this.contadorKills == 30 && meMataron) {
                this.master.play();
            } 
            //////////////////////////////////////

            if (this.contadorKills2 == 30 && meMataron) {
                this.master.play();
            }

            if (this.contadorKills == 80 && meMataron) {
                this.extreme.play();
            }

            if (this.contadorKills2 == 80 && meMataron) {
                this.extreme.play();
            }
        }
    }
